...
% via the MIQP approach as described in Chen and Lee (2017).
...
%       regression results as used in Chen and Lee (2017, Section 4)
...
[theta_hat,obj_v,gap,rtime,ncount] = IVQR_MIO(y,w,Q,tau,T,abgap,bnd);
